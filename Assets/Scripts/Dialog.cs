...
public class Dialog : MonoBehaviour
{
    ...
    //[SerializeField] private int videoDuration = 15;
    ...
    void Start()
    {
        ...
        sentences = new string[] {"Move around using the WASD or the arrow keys. Shooting is automatic. You can pause the game at any time by pressing the ESC button." };
